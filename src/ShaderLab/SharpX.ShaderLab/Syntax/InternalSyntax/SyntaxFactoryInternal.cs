...
internal static partial class SyntaxFactoryInternal
{
    ...
    public static SyntaxListInternal<TNode> List<TNode>() where TNode : ShaderLabSyntaxNodeInternal
    {
        return default;
    }

    public static SyntaxListInternal<TNode> List<TNode>(TNode node1, TNode node2) where TNode : ShaderLabSyntaxNodeInternal
    {
        return new SyntaxListInternal<TNode>(SyntaxListInternal.List(node1, node2));
    }

    public static SyntaxListInternal<TNode> List<TNode>(params TNode[]? nodes) where TNode : ShaderLabSyntaxNodeInternal
    {
        if (nodes == null)
            return default;
    ...
    public static SeparatedSyntaxListInternal<TNode> SeparatedList<TNode>(TNode node) where TNode : ShaderLabSyntaxNodeInternal
    {
        return new SeparatedSyntaxListInternal<TNode>(new SyntaxListInternal<ShaderLabSyntaxNodeInternal>(node));
    }

    public static SeparatedSyntaxListInternal<TNode> SeparatedList<TNode>(SyntaxTokenInternal token) where TNode : ShaderLabSyntaxNodeInternal
    {
        return new SeparatedSyntaxListInternal<TNode>(new SyntaxListInternal<ShaderLabSyntaxNodeInternal>(token));
    }

    public static SeparatedSyntaxListInternal<TNode> SeparatedList<TNode>(TNode node1, SyntaxTokenInternal token, TNode node2) where TNode : ShaderLabSyntaxNodeInternal
    {
        return new SeparatedSyntaxListInternal<TNode>(SyntaxListInternal.List(node1, token, node2));
    }

    public static SeparatedSyntaxListInternal<TNode> SeparatedList<TNode>(params TNode[]? nodes) where TNode : ShaderLabSyntaxNodeInternal
    {
        if (nodes == null)
            return default;
