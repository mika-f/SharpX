...
internal class BlockSyntaxInternal : StatementSyntaxInternal
{
    ...
    public BlockSyntaxInternal(SyntaxKind kind, GreenNode? attributeLists, SyntaxTokenInternal openBraceToken, GreenNode? statements, SyntaxTokenInternal closeBraceToken, DiagnosticInfo[]? diagnostics) : base(kind, diagnostics)
    {
        SlotCount = 4;
    ...
    {
        return new BlockSyntaxInternal(Kind, _attributeLists, OpenBraceToken, _statements, CloseBraceToken, diagnostics);
    }
